...
library("survminer")
ndata<-data
fit1a <- survfit(Surv(ndata$progression_time, ndata$progression_status) ~ ndata$Radiation.Therapy, data = ndata)
print(fit1a)
...
fit1b <- survfit(Surv(ndata$progression_time, ndata$progression_status==1) ~ ndata$Radiation.Therapy, 
               data = ndata)
print(fit1b)
...
fit1c <- survfit(Surv(ndata$progression_time, ndata$progression_status==2) ~ ndata$New_Tumor_event, 
               data = ndata)
print(fit1c)
...
fit1d <- survfit(Surv(ndata$progression_time, ndata$progression_status==2) ~ ndata$Prior.Diagnosis, 
               data = ndata)
print(fit1d)
